{**
 * plugins/importexport/colobok/issues.tpl
 *
 ...
 *}
{strip}
{assign var="pageTitle" value="plugins.importexport.colobok.selectIssue"}
{assign var="pageCrumbTitle" value="plugins.importexport.colobok.selectIssue"}
